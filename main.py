...
frases_voz = [
    ...
    "Oi, meus amigos, como vocês estão? Tudo bem com vocês? Principalmente com o John, que já deve estar todo arrumado.",
    ...
    "John, John, John, como é se sentir inútil, patético, uma cachorrinha que dá o cu todo dia? Como você se sente com tudo isso, hein?",
